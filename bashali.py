...
\x1b[0;33m║#FACEBOOK : NAME [ALI USMAN  II ].       ║
...
def method():
	...
	print("\n\033[1;93m[\033[1;94m?\033[1;97m] CHOOSE CRACK-ALIING MATHORD")
...
def bapi(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mCRACK-ALIing\033[0;91m]\033[0;92m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
...
def mobile(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mCRACK-ALIing\033[0;93m]\033[0;95m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
